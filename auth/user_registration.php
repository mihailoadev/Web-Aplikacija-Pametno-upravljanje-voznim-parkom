...
<head>
	...
	<title>eParking System / Registracija</title>
...
<section id="registration" data-aos="fade-down" data-aos-duration="2000">
                ...
                <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
                    ...
                    <div class="card shadow-lg">                        
                        <div class="card-body p-5">
                            <h1 class="fs-4 card-title fw-bold mb-4 text-center">Registracija</h1>
							<?php require(__DIR__ . '/../auth/registration_process.php'); ?>
                            <form action="" method="POST" class="needs-validation" novalidate="" autocomplete="off">
                                <div class="mb-3">
                                    <label class="mb-2 text-muted" for="fullname">Ime i prezime</label>
                                    <input id="name" type="text" class="form-control" name="fullname" value="" required autofocus>
                                    <div class="invalid-feedback">
                                        Ime i prezime mogu sadrzati samo slova i razmake!
                                    </div>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="invalid-feedback">
                                        Password mora imati minimum 8 karaktera, barem jedno veliko slovo, jedno malo slovo i jednu cifru!
                                    </div>
                                </div>

                                <div class="mb-3">
                                    <label class="mb-2 text-muted" for="repeatpassword">Ponovi password</label>
                                    <input id="repeat_password" type="password" class="form-control" name="repeat_password" required>
                                    <div class="invalid-feedback">
                                        Password se ne podudara!
                                    </div>
                                </div>
                        ...
                        <div class="card-footer py-3 border-0">
                            <div class="text-center">
                                Imaš nalog? <a href="user_login.php" class="text-dark">Prijavi se!</a>
                            </div>
                        </div>
                    </div>
                </div>
